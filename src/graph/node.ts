...
export class Node {
  ...
  constructor(
    ...
    this.createForwardEdges(simplifier, filters, forwardRules, poolRules);
  }
  ...
  createForwardEdges(
    ...
    this.createPoolEdges(remaining, poolRules);
  }

  createPoolEdges(filters: Disjunction<AnyRuleSpec>, poolRules: PoolRule[]) {
