...
import {asAzureVirtualNetwork, AzureResourceGraph, AzureObjectType, AzureVirtualNetwork} from './types';
...
export function convertResourceGraph(
  ...
  // Convert each VNet.
  for (const vnet of services.groups.items<AzureVirtualNetwork>(AzureObjectType.VIRTUAL_NETWORK)) {
