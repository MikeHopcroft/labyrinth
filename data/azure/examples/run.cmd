...
:DEFAULT_ROUTES
    CALL :SYM_ROUTE Internet Internet internet -r -b -v -x
    CALL :SYM_ROUTE "vm1/outbound" "vm1/inbound" vm1 -r -b -v -x
    CALL :SYM_ROUTE "vm2/outbound" "vm2/inbound" vm2 -r -b -v -x
    CALL :SYM_ROUTE "vm3/outbound" "vm3/inbound" vm3 -r -b -v -x
GOTO :EOF
